 ...
 * @precision: precision specifier
 * @size: size specifier
 * Return: number of written charecters.
 */
 ...
 * @buffer: arrays of charecters
 * @ind: index at which the number starts in the buffer
 * @length: length of number
 * @width: width specifier
 * @flags: flags specifier
 * @padd: charecter representing the padding
 * @extra_c: charecter representing an extra charecter
